...
object ScanamoScalaz {
  ...
  : Task[Option[Either[DynamoReadError, T]]] =
  ...
  : Task[List[BatchWriteItemResult]] =
  ...
  : Task[Set[Either[DynamoReadError, T]]] =
  ...
  : Task[List[Either[DynamoReadError, T]]] =
