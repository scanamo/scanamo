...
object ScanamoScalaz {
  ...
  : IO[Throwable, List[BatchWriteItemResult]] =
  ...
  : IO[Throwable, Set[Either[DynamoReadError, T]]] =
  ...
  : IO[Throwable, Either[DynamoReadError, T]] =
  ...
  : IO[Throwable, List[Either[DynamoReadError, T]]] =
